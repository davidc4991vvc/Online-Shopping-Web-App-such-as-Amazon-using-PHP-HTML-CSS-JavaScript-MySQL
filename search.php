...
$query = "SELECT * FROM Item WHERE Nom LIKE '%$searchvalue%' OR Description LIKE'%$searchvalue%' ORDER BY IdItem ASC";
...
else { echo "Il n'existe aucun produit correspondant a votre recherche"; }
 mysqli_close($con);
?>
